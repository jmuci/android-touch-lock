...
| B7 | ~~No in-app link to the Privacy Policy~~ | — | **Done (2026-08-30)** — added an underlined "Privacy Policy" text link to the bottom of `HomeScreen`, opening the live URL via `LocalUriHandler`. Signed release AAB rebuilt and verified with this change included |
