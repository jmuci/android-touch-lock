...
// Release signing credentials live outside version control, in keystore.properties (gitignored).
// See docs/PLAY_STORE_LAUNCH.md for how to generate the keystore and populate this file.
