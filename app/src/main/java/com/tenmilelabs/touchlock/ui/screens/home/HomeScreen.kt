...
internal fun HomeScreenContent(
    ...
    Column(
        modifier = Modifier
            .fillMaxSize()
            // Applied outside the scroll container so the status and navigation bars inset the
            // viewport itself: the last card can never come to rest underneath the nav bar.
            .safeDrawingPadding()
